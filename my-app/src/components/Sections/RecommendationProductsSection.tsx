  ...
  return (
    <section className="mb-10 md:py-12">
      <div className="mb-8 flex flex-col items-center justify-between gap-4 px-4 text-center md:flex-row md:gap-0 md:px-14 md:text-left">
        ...
        <a
          href="#"
          className="flex items-center justify-center gap-1 whitespace-nowrap text-base font-medium uppercase text-secondary underline hover:text-primary md:text-lg"
        >
          Shop All <ArrowRight className="size-4 md:size-5" />
        </a>
      </div>
